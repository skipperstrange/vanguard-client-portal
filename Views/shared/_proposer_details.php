...
?>            
            ...
            <div class="form-group col-lg-4 col-md-6">
                            <input type="text" id="digitalAddress"  name="proposer[residential_address]" class="form-control" title="Digital/Residential Address" placeholder="Digital Address/Location" value="" />
            </div>
