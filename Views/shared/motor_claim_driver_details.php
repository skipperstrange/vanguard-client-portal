                ...
                <span id="consent-choices" class="container">
                    ...
                    <div>
                        ...
                        <input type="radio" name="owner_driving[vehicle_consent][option]" id="vehicleconsentyes" class="purpose-radio-input vehicle-consent" value="yes">
                        <label for="vehicleconsentyes" class="purpose-radio-label">
                            <span class="label-text">Yes</span>
                        </label>
                        &nbsp;
                        &nbsp;
                        <input type="radio" name="owner_driving[vehicle_consent][option]" id="vehicleconsentno" class="purpose-radio-input vehicle-consent" value="no" checked>
                        ...
                        <div class="form-group col-lg-12 col-md-12" id="driver_has_own_vehicle">
                            ...
                            <input type="radio" name="owner_driving[driver][driver_has_own_vehicle]" 
                ...
                <span id="driver-policy-details" class="container">
                    <div class="row">
                    <div class="form-group col-lg-6 col-md-6">
                            <input type="text" id="driver-owner-relationship" name="owner_driving[driver][insurance_company]" class="form-control" placeholder="Driver Insurance Company" value="" />
                        </div>
                        <div class="form-group col-lg-6 col-md-6">
                            <input type="text" id="driver-owner-relationship" name="owner_driving[driver][policy_id]" class="form-control" placeholder="Driver Policy Number" value="" />
                        </div>
                    </div>
                </span>

                <div class="form-group col-md-12">
                    <textarea textarea name="owner_driving[purpose_of_vehicle]" title="purpose of vehicle?" class="form-control" placeholder="State fully the purpose of which the vehicle is being used." style="width: 100%; height: 100px;"></textarea>
                </div>
