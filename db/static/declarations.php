...
$declarations = [
    ...
    <div class="declaration">
        I declare that the above statment is true in all respects to the best of my knowledge and belief and I hereby leave it in the hands of hands of the company ( '. COMPANY_NAME.' )
        with the conitions of the policy of conduct of all claims and litigation arising out of this accident and to which this policy applies to deal with, to prosecute and/or settle as
        they think fit without further reffernce to me; and I undertake to give all such information and assistance the company may require.
    </div>
    <div class="declaration">
        <strong>
