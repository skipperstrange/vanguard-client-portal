    ...
    try {
        ...
        motorWizard.steps({
            ...
            onStepChanging: function(event, currentIndex, newIndex) {
                ...
                if (newIndex === 2) {
                    if (motorForm.valid()) {
                        $('.steps ul').addClass('motor-step-3');
                    } else {
                        return false
                    }
                } else {
                    $('.steps ul').removeClass('motor-step-3');
                }

                if (newIndex === 3) {
                    if (motorForm.valid()) {
                        $('.steps ul').addClass('motor-step-4');
                        //  $('.actions ul').addClass('motor-step-last');
                    } else {
                        return false
                    }
                } else {
                    $('.steps ul').removeClass('motor-step-4');
                    //  $('.actions ul').removeClass('motor-step-last');
                }

                if (newIndex === 4) {
                    if (motorForm.valid()) {
                        $('.steps ul').addClass('motor-step-5');
                        // $('.actions ul').addClass('motor-step-last');
                    } else {
                        return false
                    }
                } else {
                    $('.steps ul').removeClass('motor-step-5');
                    // $('.actions ul').removeClass('motor-step-last');
                }

                if (newIndex === 5) {
                    if (motorForm.valid()) {
                        $('.steps ul').addClass('motor-step-6');
                        try {
                    ...
                    $('.steps ul').removeClass('motor-step-6');
                    // $('.actions ul').removeClass('motor-step-last');
                }
                return true;
            },
